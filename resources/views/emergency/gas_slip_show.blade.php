    ...
    <tbody multiple>
        @foreach ($gas_slip as $user)
            <tr>
                ...
                <td>{!! Form::open(['method'=>'POST','action'=>'gasSlipController@gas_slip_get_info','files'=>true]) !!}
                    <div class="form-group">
                    <input type="hidden" name="id" id="id" value="{{$user->id}}">
                    <input type="hidden" name="emergency" id="emergency" value="0">
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('.updatePrint').on('click',function (e) {
            var urlUpdate = "{{route('gas_slip_emergency.update',':id')}}";
